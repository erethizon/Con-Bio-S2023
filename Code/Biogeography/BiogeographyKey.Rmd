...
ggsave(here("Data", "Outputs","Small 6M replicate 2equilibrium.png"), width = 6, height = 4,device = "png")
...
```{r, echo = False}
#now save your result
ggsave(here("Data", "Outputs","Small 6M replicate 2equilibrium_w_line.png"), width = 6, height = 4,device = "png")
