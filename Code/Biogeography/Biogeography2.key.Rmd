...
```{r}
IS2M<-lm(I~R, data = S2M) 
summary(IS2M)

ES2M<-lm(E~R, data = S2M) 
summary(ES2M)
...
ggplot(S2M, aes(R, I))+
   geom_point(color = "blue")+
   geom_point(aes(R, E), color = "red")+
   geom_abline(data=ES2M, intercept = ES2M$coefficients[1], 
               slope = ES2M$coefficients[2], color = "red")+
   geom_abline(data=IS2M, intercept = IS2M$coefficients[1], 
               slope = IS2M$coefficients[2], color = "blue")+
  labs(x="R (species richness)", y = "I or E", title = "Small 2M Island")
...
```{r}
ggsave(here("Data", "Outputs", "Biogeography","small_2m.png"),width = 6, height =4)
```
...
```{r}
IS6M1<-lm(I~R, data = S6M1) #creates the regression model for the colonization (I) vs. R for the Small (S), 6m (6M) island, replicate 2.

summary(IS6M1)

ES6M1 <- lm(E ~ R, data = S6M1)
summary(ES6M1)
...
ggplot(S6M1, aes(R, I))+
   geom_point(color = "blue")+
   geom_point(aes(R, E), color = "red")+
   geom_abline(data=ES6M1, intercept = ES6M1$coefficients[1], 
               slope = ES6M1$coefficients[2], color = "red")+
   geom_abline(data=IS6M1, intercept = IS6M1$coefficients[1], 
               slope = IS6M1$coefficients[2], color = "blue")+
  labs(x="R (species richness)", y = "I or E", title = "Small Island, 6 m, replicate 1")
...
```{r}
ggsave(here("Data", "Outputs", "Biogeography","small_6m_rep1.png"),width = 6, height =4)
```
...
```{r}
IL2M<-lm(I~R, data = L2M) 
summary(IL2M)

EL2M<-lm(E~R, data = L2M) 
summary(EL2M)
...
ggplot(L2M, aes(R, I))+
   geom_point(color = "blue")+
   geom_point(aes(R, E), color = "red")+
   geom_abline(data=EL2M, intercept = EL2M$coefficients[1], 
               slope = EL2M$coefficients[2], color = "red")+
   geom_abline(data=IL2M, intercept = IL2M$coefficients[1], 
               slope = IL2M$coefficients[2], color = "blue")+
  labs(x="R (species richness)", y = "I or E", title = "Large 2M Island")
...
```{r}
ggsave(here("Data", "Outputs", "Biogeography","large_2m.png"),width = 6, height =4)
```
...
```{r}
IL6M<-lm(I~R, data = L6M) 
summary(IL6M)

EL6M<-lm(E~R, data = L6M) 
summary(EL6M)
...
ggplot(L6M, aes(R, I))+
   geom_point(color = "blue")+
   geom_point(aes(R, E), color = "red")+
   geom_abline(data=EL6M, intercept = EL6M$coefficients[1], 
               slope = EL6M$coefficients[2], color = "red")+
   geom_abline(data=IL6M, intercept = IL6M$coefficients[1], 
               slope = IL6M$coefficients[2], color = "blue")+
  labs(x="R (species richness)", y = "I or E", title = "Large 6M Island")
...
```{r}
ggsave(here("Data", "Outputs", "Biogeography","large_6m.png"),width = 6, height =4)
```
