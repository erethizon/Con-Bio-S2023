...
Save the plot
```{r}
ggsave(here("Data", "Outputs", "species_richness.png"))
```
...
```{r}
ggsave(here("Data","Outputs","comparing_indices.png"), device = "png")
```
...
And save
```{r}
ggsave(here("Data", "Outputs", "Trial1_one_dominant_species.png"))
```
...
And save
```{r}
ggsave(here("Data", "Outputs", "trial2_even_species.png"))
```
